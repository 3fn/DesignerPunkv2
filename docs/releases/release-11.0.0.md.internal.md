...
- **Readiness Infrastructure** *(Infrastructure)*
- **Extraction Pipeline** *(Other)*
- **Native Platform Composition** *(Other)*
- **Web Platform Composition** *(Other)*
- **Layout Template Infrastructure** *(Infrastructure)*
- **Responsive Layout Steering Documentation** *(Documentation)*
- **Responsive Layout Learning Foundation** *(Other)*
- **Family Name Normalization** *(Other)*
- **Foundation — Registry & Directory Rename** *(Other)*
- **Coverage Drift Test** *(Other)*
- **Steering Doc Updates and Cross-Reference Integrity** *(Other)*
- **Product Handoff Protocol** *(Other)*
