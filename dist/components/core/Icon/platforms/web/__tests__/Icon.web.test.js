...
const Icon_web_1 = require("../Icon.web");
describe('Icon Component (Web)', () => {
    describe('createIcon function', () => {
        it('should render icon with correct size (width and height attributes)', () => {
            ...
            const result = (0, Icon_web_1.createIcon)(props);
        ...
        it('should handle invalid icon names with fallback to circle', () => {
            const props = {
                name: 'invalid-icon-name', // Force invalid name
                size: 24
            };
            const result = (0, Icon_web_1.createIcon)(props);
    ...
    describe('Icon class', () => {
        ...
        it('should get current icon properties', () => {
            ...
            const icon = new Icon_web_1.Icon(props);
    ...
    describe('Requirements Compliance', () => {
        ...
        it('should meet Requirement 7.1: Color override support on web', () => {
            ...
            const inheritResult = (0, Icon_web_1.createIcon)({
                name: 'arrow-right',
                size: 24,
                color: 'inherit'
            });
            expect(inheritResult).toContain('stroke="currentColor"');
            const tokenResult = (0, Icon_web_1.createIcon)({
                name: 'arrow-right',
                size: 24,
                color: 'color-text-secondary'
            });
