...
`,
            ...
            const breakingChanges = await analyzer.extractBreakingChanges(document);
            const hasAPIReferences = breakingChanges.some(bc => bc.affectedAPIs.includes('TokenValidator') ||
...
`;
            const metadata = analyzer.extractDocumentMetadata(content);
...
`,
            ...
            const confidence = analyzer.calculateDocumentConfidence(document, analysis);
    ...
    describe('Version Bump Determination', () => {
        it('should suggest major version for breaking changes', async () => {
            ...
            const versionBump = analyzer.determineSuggestedVersionBump(analysis);
    ...
    describe('Error Handling', () => {
        ...
        it('should handle malformed documents', async () => {
            ...
            mockFs.readdir.mockResolvedValue(['malformed.md']);
