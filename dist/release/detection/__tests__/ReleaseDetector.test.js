...
`;
            ...
            const strictDetector = new ReleaseDetector_1.ReleaseDetector(highThresholdConfig);
...
`;
            mockFs.readFile.mockResolvedValueOnce(completionContent);
            mockFs.readdir.mockResolvedValueOnce(['spec-completion-summary.md']);
        ...
        it('should return null when spec completion trigger is disabled', async () => {
            ...
            const disabledDetector = new ReleaseDetector_1.ReleaseDetector(disabledConfig);
...
`;
    ...
    describe('Error Handling', () => {
        ...
        it('should handle malformed completion documents', async () => {
            const documentsPath = '.kiro/specs/test-spec/completion';
            mockFs.readdir.mockResolvedValue(['invalid-file.md']);
...
//# sourceMappingURL=ReleaseDetector.test.js.map