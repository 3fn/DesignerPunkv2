...
exports.ReleaseReadinessValidator = void 0;
...
class ReleaseReadinessValidator {
     ...
     */
    async validateReleaseReadiness(releasePlan) {
        const errors = [];
        const warnings = [];
     ...
     */
    async validateCompletionDocumentation(releasePlan) {
        const errors = [];
        const warnings = [];
     ...
     */
    async validateDocumentFormat(releasePlan) {
        const errors = [];
        const warnings = [];
        for (const packageUpdate of releasePlan.packages) {
     ...
     * Validate breaking changes documentation
     */
    async validateBreakingChangesDocumentation(releasePlan) {
        const errors = [];
        const warnings = [];
     ...
     * Validate release notes completeness
     */
    validateReleaseNotesCompleteness(releasePlan) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateRequiredSections(content, docPath) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateDocumentMetadata(content, docPath) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateBreakingChangeAgainstRules(breakingChange) {
        const errors = [];
        const warnings = [];
     ...
     */
    getSpecCompletionPath(packageName) {
     ...
     */
    async getTaskCompletionPaths(packageName) {
        const specName = packageName.replace('@designerpunk/', '');
     ...
     */
    async getCompletionDocuments(packageName) {
...
exports.ReleaseReadinessValidator = ReleaseReadinessValidator;
//# sourceMappingURL=ReleaseReadinessValidator.js.map