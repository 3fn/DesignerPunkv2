...
exports.SemanticVersionValidator = void 0;
class SemanticVersionValidator {
     ...
     */
    validateVersionProgression(versionBump) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateBumpTypeConsistency(versionBump) {
        const errors = [];
        const warnings = [];
     ...
     */
    validatePreReleaseRules(versionBump) {
        const errors = [];
        const warnings = [];
...
exports.SemanticVersionValidator = SemanticVersionValidator;
//# sourceMappingURL=SemanticVersionValidator.js.map