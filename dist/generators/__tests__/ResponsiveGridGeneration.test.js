...
const ResponsiveGridGenerator_1 = require("../ResponsiveGridGenerator");
...
describe('ResponsiveGridGenerator', () => {
    let generator;
    beforeEach(() => {
        generator = new ResponsiveGridGenerator_1.ResponsiveGridGenerator();
    });
    describe('Configuration Validation', () => {
        ...
        it('should have 4 breakpoint configurations', () => {
            expect(ResponsiveGridGenerator_1.responsiveGridConfigs).toHaveLength(4);
        });
        it('should have progressive column counts (4→8→12→16)', () => {
            expect(ResponsiveGridGenerator_1.responsiveGridConfigs[0].columns).toBe(4); // xs
            expect(ResponsiveGridGenerator_1.responsiveGridConfigs[1].columns).toBe(8); // sm
            expect(ResponsiveGridGenerator_1.responsiveGridConfigs[2].columns).toBe(12); // md
            expect(ResponsiveGridGenerator_1.responsiveGridConfigs[3].columns).toBe(16); // lg
        });
        it('should reference valid breakpoint tokens', () => {
            for (const config of ResponsiveGridGenerator_1.responsiveGridConfigs) {
                expect(BreakpointTokens_1.breakpointTokens[config.breakpoint]).toBeDefined();
            }
        });
        it('should reference valid grid spacing tokens', () => {
            for (const config of ResponsiveGridGenerator_1.responsiveGridConfigs) {
                expect(GridSpacingTokens_1.gridSpacingTokens[config.gutter]).toBeDefined();
                expect(GridSpacingTokens_1.gridSpacingTokens[config.margin]).toBeDefined();
            }
        });
    });
    ...
    describe('Grid Item Styles', () => {
        ...
        it('should wrap non-xs column utilities in media queries', () => {
            ...
            const xsSection = css.substring(css.indexOf('/* XS Column Span'), css.indexOf('/* SM Column Span'));
...
//# sourceMappingURL=ResponsiveGridGeneration.test.js.map