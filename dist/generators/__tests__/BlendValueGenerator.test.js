...
const BlendValueGenerator_1 = require("../BlendValueGenerator");
const BlendTokens_1 = require("../../tokens/BlendTokens");
describe('BlendValueGenerator', () => {
    let generator;
    beforeEach(() => {
        generator = new BlendValueGenerator_1.BlendValueGenerator();
    });
    ...
    describe('Mathematical Relationships', () => {
        test('all blend tokens have correct mathematical values', () => {
            ...
            expect(tokens[0].baseValue).toBe(BlendTokens_1.BLEND_BASE_VALUE); // blend100
            expect(tokens[1].baseValue).toBe(BlendTokens_1.BLEND_BASE_VALUE * 2); // blend200
            expect(tokens[2].baseValue).toBe(BlendTokens_1.BLEND_BASE_VALUE * 3); // blend300
            expect(tokens[3].baseValue).toBe(BlendTokens_1.BLEND_BASE_VALUE * 4); // blend400
            expect(tokens[4].baseValue).toBe(BlendTokens_1.BLEND_BASE_VALUE * 5); // blend500
        });
...
//# sourceMappingURL=BlendValueGenerator.test.js.map