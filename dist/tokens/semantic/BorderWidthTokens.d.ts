 ...
 * - Android: 1dp
 */
export declare const borderDefault: BorderWidthSemanticToken;
/**
 ...
 * - Android: 2dp
 */
export declare const borderEmphasis: BorderWidthSemanticToken;
/**
 ...
 * - Android: 4dp
 */
export declare const borderHeavy: BorderWidthSemanticToken;
/**
 * Semantic border width tokens object for registry integration.
 */
export declare const SemanticBorderWidthTokens: {
    readonly borderDefault: BorderWidthSemanticToken;
    readonly borderEmphasis: BorderWidthSemanticToken;
    readonly borderHeavy: BorderWidthSemanticToken;
};
/**
