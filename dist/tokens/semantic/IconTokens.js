...
exports.iconTokenNames = exports.iconTokens = void 0;
exports.calculateIconSize = calculateIconSize;
exports.generateIconSizeTokens = generateIconSizeTokens;
exports.getIconToken = getIconToken;
exports.getAllIconTokens = getAllIconTokens;
 ...
 */
function calculateIconSize(fontSizeToken, lineHeightToken) {
 ...
 */
function generateIconSizeContext(scale) {
 ...
 */
function generateIconSizeDescription(scale, fontSize, lineHeight, calculatedSize) {
 ...
 */
function generateIconSizeTokens() {
    ...
    for (const scale of scales) {
        ...
        if (fontSize && lineHeight) {
            ...
            tokens[tokenName] = {
                ...
                category: SemanticToken_1.SemanticCategory.ICON,
 ...
 */
exports.iconTokenNames = Object.keys(exports.iconTokens);
/**
 * Get icon size token by name
 */
function getIconToken(name) {
    return exports.iconTokens[name];
}
/**
 * Get all icon size tokens as array
 */
function getAllIconTokens() {
    return Object.values(exports.iconTokens);
}
//# sourceMappingURL=IconTokens.js.map