...
exports.elevationTokenNames = exports.elevationTokens = void 0;
exports.getElevationToken = getElevationToken;
exports.getAllElevationTokens = getAllElevationTokens;
 ...
 * ```
 */
function getElevationToken(name) {
    return exports.elevationTokens[name];
}
/**
 ...
 * ```
 */
function getAllElevationTokens() {
    return Object.values(exports.elevationTokens);
}
/**
 ...
 * ```
 */
exports.elevationTokenNames = Object.keys(exports.elevationTokens);
//# sourceMappingURL=ElevationTokens.js.map