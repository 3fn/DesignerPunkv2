...
exports.gridSpacingTokenNames = exports.gridSpacingTokens = void 0;
exports.getGridSpacingToken = getGridSpacingToken;
exports.getAllGridSpacingTokens = getAllGridSpacingTokens;
 ...
 */
exports.gridSpacingTokenNames = Object.keys(exports.gridSpacingTokens);
/**
 * Get grid spacing semantic token by name
 */
function getGridSpacingToken(name) {
    return exports.gridSpacingTokens[name];
}
/**
 * Get all grid spacing semantic tokens as array
 */
function getAllGridSpacingTokens() {
    return Object.values(exports.gridSpacingTokens);
}
//# sourceMappingURL=GridSpacingTokens.js.map