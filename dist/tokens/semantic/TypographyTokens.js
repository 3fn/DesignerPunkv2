...
exports.typographyTokenNames = exports.typographyTokens = void 0;
exports.getTypographyToken = getTypographyToken;
exports.getAllTypographyTokens = getAllTypographyTokens;
 ...
 */
exports.typographyTokenNames = Object.keys(exports.typographyTokens);
/**
 * Get typography semantic token by name
 */
function getTypographyToken(name) {
    return exports.typographyTokens[name];
}
/**
 * Get all typography semantic tokens as array
 */
function getAllTypographyTokens() {
    return Object.values(exports.typographyTokens);
}
