...
describe('Shadow Offset Tokens', () => {
    describe('PrimitiveToken Object Structure', () => {
        test('should have correct structure for all shadow offset X tokens', () => {
            const allTokens = (0, ShadowOffsetTokens_1.getAllShadowOffsetXTokens)();
            allTokens.forEach(token => {
                ...
                // Validate category
                expect(token.category).toBe(PrimitiveToken_1.TokenCategory.SHADOW);
        ...
        test('should have correct structure for all shadow offset Y tokens', () => {
            const allTokens = (0, ShadowOffsetTokens_1.getAllShadowOffsetYTokens)();
            allTokens.forEach(token => {
                // Validate required fields
                expect(token).toHaveProperty('name');
                expect(token).toHaveProperty('category');
        ...
        test('should have correct token names for shadowOffsetX', () => {
            ...
            expect(ShadowOffsetTokens_1.shadowOffsetXNames).toHaveLength(9);
            expect(ShadowOffsetTokens_1.shadowOffsetXNames.sort()).toEqual(expectedNames.sort());
        });
        test('should have correct token names for shadowOffsetY', () => {
            expect(ShadowOffsetTokens_1.shadowOffsetYNames).toEqual(['100', '200', '300', '400']);
            expect(ShadowOffsetTokens_1.shadowOffsetYNames).toHaveLength(4);
        });
        test('should have all tokens in shadowOffsetX object', () => {
            expect(Object.keys(ShadowOffsetTokens_1.shadowOffsetX).sort()).toEqual(ShadowOffsetTokens_1.shadowOffsetXNames.sort());
            expect(Object.keys(ShadowOffsetTokens_1.shadowOffsetX)).toHaveLength(9);
        });
        test('should have all tokens in shadowOffsetY object', () => {
            expect(Object.keys(ShadowOffsetTokens_1.shadowOffsetY)).toEqual(ShadowOffsetTokens_1.shadowOffsetYNames);
            expect(Object.keys(ShadowOffsetTokens_1.shadowOffsetY)).toHaveLength(4);
        });
    });
    describe('Mathematical Relationships', () => {
        test('should have correct base value', () => {
            expect(ShadowOffsetTokens_1.SHADOW_OFFSET_BASE_VALUE).toBe(4);
        });
        test('should maintain correct progression for shadowOffsetX', () => {
            const n300 = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n300');
            const n200 = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n200');
            const n150 = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n150');
            const n100 = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n100');
            const zero = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('000');
            const p100 = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('100');
            const p150 = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('150');
            const p200 = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('200');
            const p300 = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('300');
        ...
        test('should maintain correct progression for shadowOffsetY', () => {
            const y100 = (0, ShadowOffsetTokens_1.getShadowOffsetYToken)('100');
            const y200 = (0, ShadowOffsetTokens_1.getShadowOffsetYToken)('200');
            const y300 = (0, ShadowOffsetTokens_1.getShadowOffsetYToken)('300');
            const y400 = (0, ShadowOffsetTokens_1.getShadowOffsetYToken)('400');
        ...
        test('should have correct familyBaseValue for all tokens', () => {
            const allXTokens = (0, ShadowOffsetTokens_1.getAllShadowOffsetXTokens)();
            const allYTokens = (0, ShadowOffsetTokens_1.getAllShadowOffsetYTokens)();
            [...allXTokens, ...allYTokens].forEach(token => {
                expect(token.familyBaseValue).toBe(ShadowOffsetTokens_1.SHADOW_OFFSET_BASE_VALUE);
    ...
    describe('Helper Functions', () => {
        ...
        test('getShadowOffsetXToken should return undefined for invalid names', () => {
            const invalidToken = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('500');
            expect(invalidToken).toBeUndefined();
        });
        test('getShadowOffsetYToken should return undefined for invalid names', () => {
            const invalidToken = (0, ShadowOffsetTokens_1.getShadowOffsetYToken)('500');
            expect(invalidToken).toBeUndefined();
        });
        test('getAllShadowOffsetXTokens should return all tokens as array', () => {
            const allTokens = (0, ShadowOffsetTokens_1.getAllShadowOffsetXTokens)();
            expect(allTokens).toHaveLength(9);
            expect(allTokens.every(token => token.category === PrimitiveToken_1.TokenCategory.SHADOW)).toBe(true);
    ...
    describe('Platform Values', () => {
        test('should have correct platform values for shadowOffsetX.000', () => {
            const token = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('000');
        ...
        test('should have correct platform values for shadowOffsetX.300', () => {
            const token = (0, ShadowOffsetTokens_1.getShadowOffsetXToken)('300');
        ...
        test('should have correct platform values for shadowOffsetY.100', () => {
            const token = (0, ShadowOffsetTokens_1.getShadowOffsetYToken)('100');
    ...
    describe('Token Properties', () => {
        test('should have correct baselineGridAlignment for shadowOffsetX tokens', () => {
            ...
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n300')?.baselineGridAlignment).toBe(true); // -12
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n200')?.baselineGridAlignment).toBe(true); // -8
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n150')?.baselineGridAlignment).toBe(false); // -6
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n100')?.baselineGridAlignment).toBe(true); // -4
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('000')?.baselineGridAlignment).toBe(true); // 0
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('100')?.baselineGridAlignment).toBe(true); // 4
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('150')?.baselineGridAlignment).toBe(false); // 6
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('200')?.baselineGridAlignment).toBe(true); // 8
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('300')?.baselineGridAlignment).toBe(true); // 12
        });
        ...
        test('should have correct isStrategicFlexibility flags', () => {
            ...
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n200')?.isStrategicFlexibility).toBe(true);
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n150')?.isStrategicFlexibility).toBe(true);
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n100')?.isStrategicFlexibility).toBe(true);
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('100')?.isStrategicFlexibility).toBe(true);
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('150')?.isStrategicFlexibility).toBe(true);
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('200')?.isStrategicFlexibility).toBe(true);
            // Non-strategic flexibility tokens
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('n300')?.isStrategicFlexibility).toBe(false);
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('000')?.isStrategicFlexibility).toBe(false);
            expect((0, ShadowOffsetTokens_1.getShadowOffsetXToken)('300')?.isStrategicFlexibility).toBe(false);
    ...
    describe('Index File Integration', () => {
        ...
        const { shadowOffsetX: indexShadowOffsetX, shadowOffsetY: indexShadowOffsetY, shadowOffsetXNames: indexShadowOffsetXNames, shadowOffsetYNames: indexShadowOffsetYNames, getShadowOffsetXToken: indexGetShadowOffsetXToken, getShadowOffsetYToken: indexGetShadowOffsetYToken, getAllShadowOffsetXTokens: indexGetAllShadowOffsetXTokens, getAllShadowOffsetYTokens: indexGetAllShadowOffsetYTokens, SHADOW_OFFSET_BASE_VALUE: indexSHADOW_OFFSET_BASE_VALUE, allTokens, getAllPrimitiveTokens, getTokensByCategory, getTokenByName, TOKEN_FAMILY_BASE_VALUES } = require('../index');
        test('should export shadow offset tokens from index', () => {
            expect(indexShadowOffsetX).toBeDefined();
            expect(indexShadowOffsetX).toEqual(ShadowOffsetTokens_1.shadowOffsetX);
            expect(indexShadowOffsetY).toBeDefined();
            expect(indexShadowOffsetY).toEqual(ShadowOffsetTokens_1.shadowOffsetY);
        });
        test('should export shadow offset token names from index', () => {
            expect(indexShadowOffsetXNames).toBeDefined();
            expect(indexShadowOffsetXNames).toEqual(ShadowOffsetTokens_1.shadowOffsetXNames);
            expect(indexShadowOffsetYNames).toBeDefined();
            expect(indexShadowOffsetYNames).toEqual(ShadowOffsetTokens_1.shadowOffsetYNames);
        });
        ...
        test('should export SHADOW_OFFSET_BASE_VALUE from index', () => {
            ...
            expect(indexSHADOW_OFFSET_BASE_VALUE).toBe(ShadowOffsetTokens_1.SHADOW_OFFSET_BASE_VALUE);
        });
        test('should include shadow offset tokens in allTokens object', () => {
            expect(allTokens[PrimitiveToken_1.TokenCategory.SHADOW]).toBeDefined();
            const shadowTokens = allTokens[PrimitiveToken_1.TokenCategory.SHADOW];
        ...
        test('should include shadow offset tokens in getAllPrimitiveTokens()', () => {
            ...
            const shadowTokensInArray = allTokensArray.filter((token) => token.category === PrimitiveToken_1.TokenCategory.SHADOW);
        ...
        test('should return shadow offset tokens from getTokensByCategory()', () => {
            const shadowTokensFromCategory = getTokensByCategory(PrimitiveToken_1.TokenCategory.SHADOW);
            ...
            expect(shadowTokensFromCategory.every((token) => token.category === PrimitiveToken_1.TokenCategory.SHADOW)).toBe(true);
            // Verify we have both X and Y tokens
            const hasXTokens = shadowTokensFromCategory.some((token) => token.name.includes('shadowOffsetX'));
            const hasYTokens = shadowTokensFromCategory.some((token) => token.name.includes('shadowOffsetY'));
        ...
        test('should retrieve shadow offset tokens by name from getTokenByName()', () => {
            ...
            expect(shadowOffsetXZero?.category).toBe(PrimitiveToken_1.TokenCategory.SHADOW);
            expect(shadowOffsetY100).toBeDefined();
            expect(shadowOffsetY100?.name).toBe('shadowOffsetY.100');
            expect(shadowOffsetY100?.category).toBe(PrimitiveToken_1.TokenCategory.SHADOW);
        });
        test('should include SHADOW in TOKEN_FAMILY_BASE_VALUES', () => {
            expect(TOKEN_FAMILY_BASE_VALUES[PrimitiveToken_1.TokenCategory.SHADOW]).toBe(4);
        });
    });
});
//# sourceMappingURL=ShadowOffsetTokens.test.js.map