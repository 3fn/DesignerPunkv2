...
exports.fontSizeTokenNames = exports.fontSizeTokens = exports.MODULAR_SCALE_RATIO = exports.FONT_SIZE_BASE_VALUE = void 0;
exports.getFontSizeToken = getFontSizeToken;
exports.getAllFontSizeTokens = getAllFontSizeTokens;
const PrimitiveToken_1 = require("../types/PrimitiveToken");
/**
 * Font size token base value for mathematical calculations
 */
exports.FONT_SIZE_BASE_VALUE = 16;
/**
 * Modular scale ratio for fontSize progression (musical fourth)
 */
exports.MODULAR_SCALE_RATIO = 1.125;
/**
 * Generate platform values for fontSize tokens
 */
function generateFontSizePlatformValues(baseValue) {
    return {
        web: { value: baseValue / exports.FONT_SIZE_BASE_VALUE, unit: 'rem' }, // Convert to 1 REM
...
exports.fontSizeTokens = {
    fontSize050: {
        ...
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE / Math.pow(exports.MODULAR_SCALE_RATIO, 2)), // ~12.6 → 13
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
    ...
    fontSize075: {
        name: 'fontSize075',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE / exports.MODULAR_SCALE_RATIO), // ~14.2 → 14
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
    ...
    fontSize100: {
        name: 'fontSize100',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: exports.FONT_SIZE_BASE_VALUE,
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
        ...
        isStrategicFlexibility: false,
        isPrecisionTargeted: false,
        platforms: generateFontSizePlatformValues(exports.FONT_SIZE_BASE_VALUE)
    },
    fontSize125: {
        name: 'fontSize125',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE * exports.MODULAR_SCALE_RATIO), // 18
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
    ...
    fontSize150: {
        name: 'fontSize150',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 2)), // ~20.3 → 20
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
    ...
    fontSize200: {
        name: 'fontSize200',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 3)), // ~22.8 → 23
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
    ...
    fontSize300: {
        name: 'fontSize300',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 4)), // ~25.6 → 26
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
    ...
    fontSize400: {
        name: 'fontSize400',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 5)), // ~28.8 → 29
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
    ...
    fontSize500: {
        name: 'fontSize500',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 6)) + 1, // ~32.4 → 32 + 1 = 33 (adjusted for 4pt subgrid)
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
        ...
        platforms: generateFontSizePlatformValues(Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 6)) + 1)
    },
    fontSize600: {
        name: 'fontSize600',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 7)) + 1, // ~36.5 → 36 + 1 = 37 (adjusted for 4pt subgrid)
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
        ...
        isStrategicFlexibility: false,
        isPrecisionTargeted: true, // Adjusted for 4pt subgrid alignment
        platforms: generateFontSizePlatformValues(Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 7)) + 1)
    },
    fontSize700: {
        name: 'fontSize700',
        category: PrimitiveToken_1.TokenCategory.FONT_SIZE,
        baseValue: Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 8)) + 1, // ~41.1 → 41 + 1 = 42 (adjusted for 4pt subgrid)
        familyBaseValue: exports.FONT_SIZE_BASE_VALUE,
        ...
        isStrategicFlexibility: false,
        isPrecisionTargeted: true, // Adjusted for 4pt subgrid alignment
        platforms: generateFontSizePlatformValues(Math.round(exports.FONT_SIZE_BASE_VALUE * Math.pow(exports.MODULAR_SCALE_RATIO, 8)) + 1)
    }
};
/**
 * Array of all font size token names for iteration
 */
exports.fontSizeTokenNames = Object.keys(exports.fontSizeTokens);
/**
 * Get font size token by name
 */
function getFontSizeToken(name) {
    return exports.fontSizeTokens[name];
}
/**
 * Get all font size tokens as array
 */
function getAllFontSizeTokens() {
    return Object.values(exports.fontSizeTokens);
}
