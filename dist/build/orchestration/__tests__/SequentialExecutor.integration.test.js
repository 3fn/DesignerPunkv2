...
describe('SequentialExecutor Integration', () => {
    const createRealisticBuildFn = (failPlatforms = []) => {
    ...
    describe('error handling', () => {
        it('should handle timeout gracefully', async () => {
            const executor = new SequentialExecutor_1.SequentialExecutor({ buildTimeout: 100 });
            const platforms = ['web', 'ios'];
            const buildFn = async (platform) => {
                if (platform === 'ios') {
...
//# sourceMappingURL=SequentialExecutor.integration.test.js.map