...
describe('ProgressTracker', () => {
    describe('initialization', () => {
        it('should initialize with platforms', () => {
            ...
            const tracker = new ProgressTracker_1.ProgressTracker(platforms);
    ...
    describe('platform tracking', () => {
        it('should start platform build', () => {
            const tracker = new ProgressTracker_1.ProgressTracker(['ios']);
        ...
        it('should update platform progress', () => {
            const tracker = new ProgressTracker_1.ProgressTracker(['android']);
        ...
        it('should complete platform build', () => {
            const tracker = new ProgressTracker_1.ProgressTracker(['web']);
    ...
    describe('overall progress calculation', () => {
        it('should calculate overall progress from platform progress', () => {
            const tracker = new ProgressTracker_1.ProgressTracker(['ios', 'android', 'web']);
            tracker.startPlatform('ios');
    ...
    describe('completion report generation', () => {
        it('should generate successful build report', () => {
            const tracker = new ProgressTracker_1.ProgressTracker(['ios', 'android']);
            const results = [
                {
                    platform: 'ios',
                    success: true,
    ...
    describe('duration formatting', () => {
        it('should format seconds', () => {
            expect(ProgressTracker_1.ProgressTracker.formatDuration(5000)).toBe('5s');
            expect(ProgressTracker_1.ProgressTracker.formatDuration(45000)).toBe('45s');
        });
        it('should format minutes and seconds', () => {
            expect(ProgressTracker_1.ProgressTracker.formatDuration(65000)).toBe('1m 5s');
            expect(ProgressTracker_1.ProgressTracker.formatDuration(125000)).toBe('2m 5s');
        });
        it('should format hours, minutes, and seconds', () => {
            expect(ProgressTracker_1.ProgressTracker.formatDuration(3665000)).toBe('1h 1m 5s');
            expect(ProgressTracker_1.ProgressTracker.formatDuration(7325000)).toBe('2h 2m 5s');
        });
    });
    describe('progress report formatting', () => {
        it('should format progress report', () => {
            ...
            const progress = tracker.getProgress();
            const formatted = ProgressTracker_1.ProgressTracker.formatProgressReport(progress);
    ...
    describe('completion report formatting', () => {
        it('should format completion report', () => {
            const tracker = new ProgressTracker_1.ProgressTracker(['ios', 'web']);
            const results = [
                {
                    platform: 'ios',
                    success: true,
            ...
            tracker.complete();
            const report = tracker.generateReport(results);
            const formatted = ProgressTracker_1.ProgressTracker.formatCompletionReport(report);
