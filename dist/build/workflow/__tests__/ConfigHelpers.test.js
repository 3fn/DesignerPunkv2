...
describe('ConfigHelpers', () => {
    describe('createFromTemplate', () => {
        it('should create minimal configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('minimal');
        ...
        it('should create development configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('development');
            expect(config.mode).toBe('development');
        ...
        it('should create production configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('production');
        ...
        it('should create all-platforms configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('all-platforms');
        ...
        it('should create iOS-only configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('ios-only');
        ...
        it('should create Android-only configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('android-only');
        ...
        it('should create Web-only configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('web-only');
            expect(config.platforms).toEqual(['web']);
            expect(config.ios).toBeUndefined();
            expect(config.android).toBeUndefined();
            expect(config.web).toBeDefined();
        ...
        it('should create mobile configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('mobile');
        ...
        it('should create CI/CD configuration', () => {
            const config = ConfigHelpers_1.ConfigHelpers.createFromTemplate('ci-cd');
            expect(config.platforms).toEqual(['ios', 'android', 'web']);
            expect(config.mode).toBe('production');
            expect(config.parallel).toBe(true);
            expect(config.minify).toBe(true);
        ...
        it('should throw error for unknown template', () => {
            expect(() => {
                ConfigHelpers_1.ConfigHelpers.createFromTemplate('unknown');
    ...
    describe('validateConfiguration', () => {
        it('should validate valid configuration', () => {
            ...
            const result = ConfigHelpers_1.ConfigHelpers.validateConfiguration(config);
    ...
    describe('migrateConfiguration', () => {
        it('should migrate platform to platforms array', () => {
            ...
            const result = ConfigHelpers_1.ConfigHelpers.migrateConfiguration(oldConfig);
...
//# sourceMappingURL=ConfigHelpers.test.js.map