...
exports.ERROR_DOCUMENTATION = void 0;
exports.getErrorDocumentation = getErrorDocumentation;
exports.enhanceErrorWithDocumentation = enhanceErrorWithDocumentation;
exports.addErrorLocation = addErrorLocation;
 ...
 */
exports.ERROR_DOCUMENTATION = {
    // Configuration Errors
    [BuildError_1.ErrorCodes.CONFIG_INVALID_PLATFORM]: {
        ...
        relatedErrors: [BuildError_1.ErrorCodes.CONFIG_MISSING_REQUIRED],
    },
    [BuildError_1.ErrorCodes.CONFIG_MISSING_REQUIRED]: {
        ...
        relatedErrors: [BuildError_1.ErrorCodes.CONFIG_INVALID_PLATFORM, BuildError_1.ErrorCodes.CONFIG_INVALID_OUTPUT_DIR],
    },
    [BuildError_1.ErrorCodes.CONFIG_CONFLICTING_OPTIONS]: {
        code: BuildError_1.ErrorCodes.CONFIG_CONFLICTING_OPTIONS,
    ...
    [BuildError_1.ErrorCodes.CONFIG_INVALID_OUTPUT_DIR]: {
        code: BuildError_1.ErrorCodes.CONFIG_INVALID_OUTPUT_DIR,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.BUILD_PACKAGE_GENERATION_FAILED],
    },
    // Build Errors
    [BuildError_1.ErrorCodes.BUILD_COMPILATION_FAILED]: {
        ...
        relatedErrors: [BuildError_1.ErrorCodes.BUILD_MISSING_DEPENDENCY, BuildError_1.ErrorCodes.INTERFACE_METHOD_MISMATCH],
    },
    [BuildError_1.ErrorCodes.BUILD_MISSING_DEPENDENCY]: {
        code: BuildError_1.ErrorCodes.BUILD_MISSING_DEPENDENCY,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.BUILD_COMPILATION_FAILED],
    },
    [BuildError_1.ErrorCodes.BUILD_INVALID_SOURCE]: {
        code: BuildError_1.ErrorCodes.BUILD_INVALID_SOURCE,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.INTERFACE_MISSING_IMPLEMENTATION, BuildError_1.ErrorCodes.TOKEN_NOT_FOUND],
    },
    [BuildError_1.ErrorCodes.BUILD_PACKAGE_GENERATION_FAILED]: {
        code: BuildError_1.ErrorCodes.BUILD_PACKAGE_GENERATION_FAILED,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.BUILD_COMPILATION_FAILED, BuildError_1.ErrorCodes.CONFIG_INVALID_OUTPUT_DIR],
    },
    // Token Errors
    [BuildError_1.ErrorCodes.TOKEN_NOT_FOUND]: {
        ...
        relatedErrors: [BuildError_1.ErrorCodes.TOKEN_INVALID_SELECTION],
    },
    [BuildError_1.ErrorCodes.TOKEN_INVALID_SELECTION]: {
        code: BuildError_1.ErrorCodes.TOKEN_INVALID_SELECTION,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.TOKEN_NOT_FOUND],
    },
    [BuildError_1.ErrorCodes.TOKEN_MATHEMATICAL_INCONSISTENCY]: {
        code: BuildError_1.ErrorCodes.TOKEN_MATHEMATICAL_INCONSISTENCY,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.TOKEN_CONVERSION_FAILED],
    },
    [BuildError_1.ErrorCodes.TOKEN_CONVERSION_FAILED]: {
        code: BuildError_1.ErrorCodes.TOKEN_CONVERSION_FAILED,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.TOKEN_MATHEMATICAL_INCONSISTENCY],
    },
    // Interface Errors
    [BuildError_1.ErrorCodes.INTERFACE_METHOD_MISMATCH]: {
        ...
        relatedErrors: [BuildError_1.ErrorCodes.INTERFACE_PROPERTY_MISMATCH, BuildError_1.ErrorCodes.INTERFACE_BEHAVIORAL_INCONSISTENCY],
    },
    [BuildError_1.ErrorCodes.INTERFACE_PROPERTY_MISMATCH]: {
        code: BuildError_1.ErrorCodes.INTERFACE_PROPERTY_MISMATCH,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.INTERFACE_METHOD_MISMATCH, BuildError_1.ErrorCodes.INTERFACE_BEHAVIORAL_INCONSISTENCY],
    },
    [BuildError_1.ErrorCodes.INTERFACE_MISSING_IMPLEMENTATION]: {
        code: BuildError_1.ErrorCodes.INTERFACE_MISSING_IMPLEMENTATION,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.BUILD_INVALID_SOURCE],
    },
    [BuildError_1.ErrorCodes.INTERFACE_BEHAVIORAL_INCONSISTENCY]: {
        code: BuildError_1.ErrorCodes.INTERFACE_BEHAVIORAL_INCONSISTENCY,
        ...
        relatedErrors: [BuildError_1.ErrorCodes.INTERFACE_METHOD_MISMATCH, BuildError_1.ErrorCodes.INTERFACE_PROPERTY_MISMATCH],
    },
};
/**
...
function getErrorDocumentation(code) {
    return exports.ERROR_DOCUMENTATION[code];
}
/**
 * Enhance a BuildError with comprehensive documentation and suggestions
 */
function enhanceErrorWithDocumentation(error) {
 ...
 */
function addErrorLocation(error, location) {
    return {
        ...error,
        context: {
            ...error.context,
...
function formatErrorMessage(error) {
    ...
    if (error.platform || error.component) {
        const info = [];
        if (error.platform)
            info.push(`Platform: ${error.platform}`);
        if (error.component)
            info.push(`Component: ${error.component}`);
    ...
    if (error.context.examples && Array.isArray(error.context.examples)) {
        parts.push('\nExamples:');
        error.context.examples.forEach(example => {
            parts.push(`  • ${example}`);
        });
    }
    // Related errors
    if (error.context.relatedErrors && Array.isArray(error.context.relatedErrors)) {
        parts.push('\nRelated Errors:');
        error.context.relatedErrors.forEach(related => {
            parts.push(`  • ${related}`);
        });
    }
    return parts.join('\n');
...
//# sourceMappingURL=ErrorDocumentation.js.map