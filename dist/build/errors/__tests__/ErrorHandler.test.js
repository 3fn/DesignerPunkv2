...
describe('ErrorHandler', () => {
    ...
    describe('constructor', () => {
        it('should create ErrorHandler with default options', () => {
            ...
            expect(handler).toBeInstanceOf(ErrorHandler_1.ErrorHandler);
        });
    ...
    describe('error logging', () => {
        ...
        it('should accumulate multiple errors', () => {
            const error1 = (0, BuildError_1.createBuildError)({
                code: 'ERROR_1',
                message: 'First error',
                severity: 'error',
                category: 'build',
            });
            const error2 = (0, BuildError_1.createBuildError)({
                code: 'ERROR_2',
    ...
    describe('error filtering', () => {
        beforeEach(() => {
            errorHandler.handleError((0, BuildError_1.createBuildError)({
                code: 'CONFIG_ERROR',
    ...
    describe('categorizeError', () => {
        it('should return BuildError as-is', () => {
            const buildError = (0, BuildError_1.createBuildError)({
                code: 'TEST_ERROR',
                message: 'Test error',
                severity: 'error',
                category: 'build',
    ...
    describe('custom logger', () => {
        it('should use custom logger when provided', () => {
            ...
            const handler = new ErrorHandler_1.ErrorHandler({ logger: customLogger });
            const error = (0, BuildError_1.createBuildError)({
                code: 'TEST_ERROR',
                message: 'Test error',
                severity: 'error',
    ...
    describe('continueOnPlatformFailure option', () => {
        it('should skip platform errors when continueOnPlatformFailure is true', () => {
            const handler = new ErrorHandler_1.ErrorHandler({ continueOnPlatformFailure: true });
            const error = (0, BuildError_1.createBuildError)({
                code: 'BUILD_ERROR',
                message: 'iOS build failed',
                severity: 'error',
        ...
        it('should not skip platform errors when continueOnPlatformFailure is false', () => {
            const handler = new ErrorHandler_1.ErrorHandler({ continueOnPlatformFailure: false });
            const error = (0, BuildError_1.createBuildError)({
                code: 'BUILD_ERROR',
                message: 'iOS build failed',
                severity: 'error',
