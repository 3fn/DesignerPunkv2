...
exports.unitConverter = exports.UnitConverter = void 0;
/**
 * Unit Converter for cross-platform token values
 */
class UnitConverter {
    constructor() {
        this.defaultWebBaseFontSize = 16;
    ...
    convertToAllPlatforms(baseValue, tokenName, options = {}) {
        ...
        const validation = this.validateMathematicalConsistency(baseValue, ios, android, web, options);
        return {
            ios,
            android,
            web,
    ...
    convertToAndroid(baseValue, tokenName, options = {}) {
        ...
        const unit = this.isTypographyToken(tokenName, options.category)
            ? 'sp'
            : 'dp';
        return {
            value,
