...
exports.WebBuildValidator = void 0;
class WebBuildValidator {
    /**
     ...
     */
    validatePackageJsonSyntax(jsonString) {
        const errors = [];
        try {
     ...
     */
    validateCSSCustomProperties(css) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateCSSNamingConventions(css) {
        const errors = [];
        const warnings = [];
     ...
     */
    validatePackageStructure(structure) {
        const errors = [];
        const warnings = [];
        // Required files
        const requiredFiles = [
     ...
     */
    validateESMSupport(packageJson) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateCommonJSSupport(packageJson) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateShadowDOMSupport(componentCode) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateCustomElementsRegistration(componentCode) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateCSSScopingOptimization(css) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateTreeShakingSupport(packageJson) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateMinification(code, mode) {
        const errors = [];
        const warnings = [];
        if (mode === 'production') {
     ...
     */
    validateCompleteBuild(buildOutput) {
        const allErrors = [];
        const allWarnings = [];
...
exports.WebBuildValidator = WebBuildValidator;
//# sourceMappingURL=WebBuildValidator.js.map