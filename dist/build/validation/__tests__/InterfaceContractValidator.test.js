...
const InterfaceContractValidator_1 = require("../InterfaceContractValidator");
describe('InterfaceContractValidator', () => {
    let validator;
    beforeEach(() => {
        validator = new InterfaceContractValidator_1.InterfaceContractValidator();
    });
    describe('validateInterfaceContracts', () => {
        ...
        it('should detect method signature mismatches across platforms', () => {
            ...
            const methodDiff = result.apiDifferences.find(d => d.type === 'method' && d.description.includes('setValue'));
        ...
        it('should detect property type mismatches across platforms', () => {
            ...
            const result = validator.validateInterfaceContracts(interfaces);
            expect(result.valid).toBe(false);
            const propertyDiff = result.apiDifferences.find(d => d.type === 'property' && d.name === 'count');
    ...
    describe('cross-platform consistency', () => {
        ...
        it('should detect inconsistencies across any platform pair', () => {
            ...
            const webDiff = result.apiDifferences.find(d => d.platforms.includes('web'));
            expect(webDiff).toBeDefined();
        });
    });
});
//# sourceMappingURL=InterfaceContractValidator.test.js.map