...
const TokenComparator_1 = require("../TokenComparator");
...
describe('TokenComparator', () => {
    ...
    beforeEach(() => {
        ...
        comparator = new TokenComparator_1.TokenComparator(primitiveRegistry, semanticRegistry);
    });
    // Helper function to create valid primitive tokens
    const createPrimitiveToken = (name, baseValue, platforms) => ({
        name,
    ...
    describe('Semantic Token Comparison', () => {
        ...
        it('should throw error if primitive reference not found', async () => {
            ...
            semanticRegistry.register(semanticToken);
            await expect(comparator.compareToken({
                token: semanticToken,
                platforms: ['ios', 'android', 'web']
    ...
    describe('Batch Token Comparison', () => {
        it('should compare multiple tokens and generate summary', async () => {
            ...
            const result = await comparator.compareTokens([token1, token2], ['ios', 'android', 'web']);
        ...
        it('should provide platform issue tracking in batch results', async () => {
            ...
            const result = await comparator.compareTokens(tokens, ['ios', 'android', 'web']);
...
//# sourceMappingURL=TokenComparator.test.js.map