...
describe('ValidationReporter Integration', () => {
    ...
    beforeEach(() => {
        ...
        reporter = new ValidationReporter_1.ValidationReporter();
    });
    it('should generate comprehensive report from interface validation', () => {
        ...
        const propertySuggestion = detailedReport.suggestions.find(s => s.title === 'Fix Property Mismatches');
...
//# sourceMappingURL=ValidationReporter.integration.test.js.map