...
exports.basicValidationReport = basicValidationReport;
...
exports.accessReportSections = accessReportSections;
exports.filterErrorsByType = filterErrorsByType;
exports.checkPlatformStatus = checkPlatformStatus;
exports.cicdValidation = cicdValidation;
...
function basicValidationReport() {
    const validator = new InterfaceValidator_1.InterfaceValidator();
    const reporter = new ValidationReporter_1.ValidationReporter();
...
//# sourceMappingURL=ValidationReporter.example.js.map