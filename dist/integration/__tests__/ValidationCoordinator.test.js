...
const ValidationCoordinator_1 = require("../ValidationCoordinator");
...
const createSpacingToken = (name, value) => createMockToken({
    name,
    category: types_1.TokenCategory.SPACING,
    baseValue: value,
...
const createSemanticToken = (name, primitiveRef) => ({
    name,
...
describe('ValidationCoordinator', () => {
    ...
    beforeEach(() => {
        ...
        coordinator = new ValidationCoordinator_1.ValidationCoordinator(validator, primitiveRegistry, semanticRegistry, {
...
//# sourceMappingURL=ValidationCoordinator.test.js.map