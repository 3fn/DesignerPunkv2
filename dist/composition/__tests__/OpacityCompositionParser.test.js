...
const OpacityCompositionParser_1 = require("../OpacityCompositionParser");
...
describe('OpacityCompositionParser', () => {
    ...
    beforeEach(() => {
        ...
        // Create parser
        parser = new OpacityCompositionParser_1.OpacityCompositionParser(primitiveRegistry, semanticRegistry);
    });
    describe('parse()', () => {
...
//# sourceMappingURL=OpacityCompositionParser.test.js.map