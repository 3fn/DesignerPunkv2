...
export interface PlatformValues {
    web: {
        ...
        unit: 'px' | 'rem' | 'unitless' | 'fontFamily' | 'fontWeight' | 'em' | 'hex';
    };
    ios: {
        value: number | string | ColorTokenValue;
        unit: 'pt' | 'unitless' | 'fontFamily' | 'fontWeight' | 'em' | 'hex';
    };
    android: {
        value: number | string | ColorTokenValue;
        unit: 'dp' | 'sp' | 'unitless' | 'fontFamily' | 'fontWeight' | 'em' | 'hex';
    };
}
/**
...
//# sourceMappingURL=PrimitiveToken.d.ts.map