...
const PlatformFileSelector_1 = require("../../integration/PlatformFileSelector");
...
describe('Build System Compatibility Integration', () => {
    ...
    describe('Platform File Selection', () => {
        let selector;
        beforeEach(() => {
            selector = new PlatformFileSelector_1.PlatformFileSelector({
                strategy: 'auto',
                fallback: 'web'
            });
        ...
        it('should handle invalid platform gracefully', () => {
            const testSelector = new PlatformFileSelector_1.PlatformFileSelector({
                strategy: 'explicit',
                fallback: 'web',
                strict: false
            });
...
//# sourceMappingURL=BuildSystemCompatibility.test.js.map