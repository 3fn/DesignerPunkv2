...
const TreeShakingOptimizer_1 = require("../../integration/TreeShakingOptimizer");
...
describe('Optimization Validation', () => {
    describe('Tree-Shaking Optimization', () => {
        ...
        let semanticTokens;
        beforeEach(() => {
            optimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({
                level: 'basic',
                sideEffectFree: true,
        ...
        it('should optimize primitive tokens with aggressive level', () => {
            const aggressiveOptimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({
                level: 'aggressive',
                sideEffectFree: true
            });
        ...
        it('should preserve specified tokens during optimization', () => {
            const preserveOptimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({
                level: 'aggressive',
                preserve: ['space700']
            });
    ...
    describe('Tree-Shakable Export Generation', () => {
        ...
        it('should generate grouped exports when individual exports disabled', () => {
            const groupedOptimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({
    ...
    describe('Side-Effects Configuration', () => {
        it('should generate side-effect free configuration', () => {
            const optimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({
                sideEffectFree: true
            });
    ...
    describe('Usage Analysis', () => {
        ...
        it('should recommend enabling optimization when disabled', () => {
            const noneOptimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({
                level: 'none'
            });
            const usedTokens = ['token1'];
    ...
    describe('Optimization Level Impact', () => {
        ...
        it('should not remove tokens with none optimization', () => {
            const optimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({ level: 'none' });
            const result = optimizer.optimizePrimitiveTokens(primitiveTokens);
            expect(result.optimizedCount).toBe(result.originalCount);
        });
        it('should preserve all tokens with basic optimization', () => {
            const optimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({ level: 'basic' });
            const result = optimizer.optimizePrimitiveTokens(primitiveTokens);
            expect(result.optimizedCount).toBe(result.originalCount);
        });
        it('should remove strategic flexibility tokens with aggressive optimization', () => {
            const optimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({ level: 'aggressive' });
            const result = optimizer.optimizePrimitiveTokens(primitiveTokens);
    ...
    describe('Performance Impact', () => {
        ...
        it('should generate exports quickly', () => {
            const optimizer = new TreeShakingOptimizer_1.TreeShakingOptimizer({ individualExports: true });
...
//# sourceMappingURL=OptimizationValidation.test.js.map