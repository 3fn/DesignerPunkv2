...
/// Generated: 2025-11-19T07:53:37.070Z
/// Version: 1.0.0
...
public struct DesignTokens {
    ...
    public static let violet100: UIColor = UIColor { traitCollection in /* dynamic color implementation */ }
    /// Systematic violet scale progression - medium-light
    public static let violet200: UIColor = UIColor { traitCollection in /* dynamic color implementation */ }
    /// Systematic violet scale progression - secondary brand
    public static let violet300: UIColor = UIColor { traitCollection in /* dynamic color implementation */ }
    /// Systematic violet scale progression - dark
    public static let violet400: UIColor = UIColor { traitCollection in /* dynamic color implementation */ }
    /// Systematic violet scale progression - darkest
    public static let violet500: UIColor = UIColor { traitCollection in /* dynamic color implementation */ }
    ...
    /// N/A - Categorical value
    public static let fontFamilyDisplay: String = "Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif"
    /// N/A - Categorical value
    ...
    public static let lineHeight050: CGFloat = 1
    /// base × 0.833 = 1.5 × 0.833 ≈ 1.25
    public static let lineHeight075: CGFloat = 1.25
    /// base × 1 = 1.5 × 1 = 1.5
    public static let lineHeight100: CGFloat = 1.5
    /// base × 1.167 = 1.5 × 1.167 ≈ 1.75
    public static let lineHeight125: CGFloat = 1.75
