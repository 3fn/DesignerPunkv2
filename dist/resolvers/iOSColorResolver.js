...
class iOSColorResolver {
     ...
     */
    generateDynamicColor(tokenName, colorValue, options = {}) {
        const { includeThemeSwitching = true, defaultTheme = 'base' } = options;
     ...
     */
    generateSwiftExtension(tokens, options = {}) {
        const { extensionName = 'DesignSystemColors' } = options;
        let swift = '//\n';
     ...
     */
    generateUsageExample(extensionName = 'DesignSystemColors') {
        let example = '//\n';
...
exports.iOSColorResolver = iOSColorResolver;
//# sourceMappingURL=iOSColorResolver.js.map