 ...
 */
async function exampleInteractiveAnalysis() {
 ...
 */
async function exampleDryRunPreview() {
 ...
 */
async function exampleHistoryManagement() {
 ...
 */
async function exampleAdvancedWorkflow() {
 ...
 */
async function exampleCommandLineUsage() {
    ...
    for (const args of scenarios) {
        ...
        try {
            ...
            const parsed = cli.parseAdvancedArguments(args);
