...
describe('CompletionDocumentCollector', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        jest.resetModules();
        mockConfig = { ...AnalysisConfig_1.DEFAULT_ANALYSIS_CONFIG };
        collector = new CompletionDocumentCollector_1.CompletionDocumentCollector('/test/workspace', mockConfig);
        // Default mocks
...
`);
            ...
            const testCollector = new CompletionDocumentCollector_1.CompletionDocumentCollector('/test/workspace', mockConfig);
            const gitChanges = {
                commits: [],
                addedFiles: [
...
//# sourceMappingURL=CompletionDocumentCollector.test.js.map