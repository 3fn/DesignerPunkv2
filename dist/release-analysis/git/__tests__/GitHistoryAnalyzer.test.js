...
describe('GitHistoryAnalyzer', () => {
    ...
    beforeEach(() => {
        analyzer = new GitHistoryAnalyzer_1.GitHistoryAnalyzer(mockWorkingDir);
        jest.clearAllMocks();
        // Default mocks
...
D\told-file.ts`;
        ...
        it('should throw error for invalid reference', async () => {
            ...
            await expect(analyzer.getChangesSince('invalid-tag')).rejects.toThrow('Failed to get changes since invalid-tag');
        });
    });
...
Task completed successfully.`;
            ...
            mockStatSync.mockReturnValue({ mtime: new Date('2025-01-15') });
    ...
    describe('private methods', () => {
        it('should identify release tags correctly', () => {
            ...
            const isReleaseTag = analyzer.isReleaseTag.bind(analyzer);
        ...
        it('should identify completion documents correctly', () => {
            const analyzer = new GitHistoryAnalyzer_1.GitHistoryAnalyzer();
            const isCompletionDocument = analyzer.isCompletionDocument.bind(analyzer);
        ...
        it('should extract document metadata correctly', () => {
            const analyzer = new GitHistoryAnalyzer_1.GitHistoryAnalyzer();
            const extractMetadata = analyzer.extractDocumentMetadata.bind(analyzer);
...
//# sourceMappingURL=GitHistoryAnalyzer.test.js.map