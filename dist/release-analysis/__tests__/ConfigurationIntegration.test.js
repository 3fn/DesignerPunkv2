...
describe('Configuration Integration Tests', () => {
    ...
    beforeEach(async () => {
        ...
        mockReadFileSync = fsModule.readFileSync;
        mockWriteFileSync = fsModule.writeFileSync;
        mockMkdirSync = fsModule.mkdirSync;
        // Reset all mocks
        jest.clearAllMocks();
    });
    afterEach(async () => {
    ...
    describe('Environment Variable Overrides', () => {
        ...
        it('should ignore invalid environment variable values', async () => {
            ...
            expect(result.config.extraction.confidenceThresholds.minimumConfidence).toBe(AnalysisConfig_1.DEFAULT_ANALYSIS_CONFIG.extraction.confidenceThresholds.minimumConfidence);
            expect(result.config.reporting.defaultFormat).toBe(AnalysisConfig_1.DEFAULT_ANALYSIS_CONFIG.reporting.defaultFormat);
            expect(result.config.git.maxCommits).toBe(AnalysisConfig_1.DEFAULT_ANALYSIS_CONFIG.git.maxCommits);
        });
    ...
    describe('Configuration Persistence', () => {
        it('should save configuration to file', async () => {
            ...
            expect(mockWriteFileSync).toHaveBeenCalledWith(configPath, expect.stringContaining('"breakingChangeKeywords"'), 'utf8');
        });
        ...
        it('should create default configuration file', async () => {
            ...
            expect(mockWriteFileSync).toHaveBeenCalledWith(configPath, expect.stringContaining('"extraction"'), 'utf8');
        });
    });
...
//# sourceMappingURL=ConfigurationIntegration.test.js.map