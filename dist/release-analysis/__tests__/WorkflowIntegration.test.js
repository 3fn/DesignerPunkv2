...
describe('Workflow Integration Tests', () => {
    let gitAnalyzer;
    let changeExtractor;
    let versionCalculator;
    let noteGenerator;
    let configManager;
    beforeEach(() => {
        // Initialize components
        gitAnalyzer = new GitHistoryAnalyzer_1.GitHistoryAnalyzer('/test/workspace');
        changeExtractor = new SimpleChangeExtractor_1.SimpleChangeExtractor(AnalysisConfig_1.DEFAULT_ANALYSIS_CONFIG.extraction);
        versionCalculator = new VersionCalculator_1.VersionCalculator();
        noteGenerator = new ReleaseNoteGenerator_1.ReleaseNoteGenerator();
        ...
        const mockStatSync = fs.statSync;
...
//# sourceMappingURL=WorkflowIntegration.test.js.map