...
describe('Performance Regression Tests', () => {
    ...
    beforeAll(async () => {
        ...
        testDir = (0, path_1.join)((0, os_1.tmpdir)(), `perf-regression-${Date.now()}`);
        ...
        benchmarkRunner = new PerformanceBenchmarkRunner_1.PerformanceBenchmarkRunner(testDir, analysisConfig, {
    ...
    describe('Performance Target Validation', () => {
         ...
         */
        test.each(REGRESSION_TESTS)('should meet performance targets for $name', async (config) => {
            const testConfig = {
                name: config.name,
    ...
    describe('Regression Detection', () => {
         ...
         */
        test.each(REGRESSION_TESTS)('should not regress from baseline for $name', async (config) => {
            const testConfig = {
                name: config.name,
...
//# sourceMappingURL=PerformanceRegression.test.js.map