...
export type { CategorizationResult, SeverityAssessment, FeatureClassification, ImprovementClassification, BugFixClassification } from './ChangeCategorizationSystem';
export { CompletionDocument, ExtractedChanges, DocumentChanges, ExtractionValidation, BreakingChange, Feature, BugFix, Improvement, DocumentationChange, PatternMatch, SectionMatch, ExtractionMetadata } from '../types/AnalysisTypes';
