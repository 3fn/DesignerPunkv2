...
describe('Accuracy Regression Tests', () => {
    ...
    describe('Baseline Accuracy Standards', () => {
        it('should maintain minimum 85% accuracy for structured documents', async () => {
            const structuredTestCases = [
                ...
                AccuracyTestCases_1.AccuracyTestCases.getHighConfidenceTestCase()
            ];
        ...
        it('should maintain minimum 70% accuracy for unstructured documents', async () => {
            const unstructuredTestCases = [
                AccuracyTestCases_1.AccuracyTestCases.getUnstructuredMixedTestCase()
            ];
        ...
        it('should maintain minimum 60% accuracy for low confidence scenarios', async () => {
            const lowConfidenceTestCases = [
                AccuracyTestCases_1.AccuracyTestCases.getLowConfidenceTestCase()
            ];
    ...
    describe('Version Bump Accuracy Standards', () => {
        it('should correctly identify major version bumps with 95% accuracy', async () => {
            const majorBumpTestCases = [
                AccuracyTestCases_1.AccuracyTestCases.getStructuredBreakingChangeTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getVersionBumpMajorTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getUnstructuredMixedTestCase() // Has breaking changes
            ];
        ...
        it('should correctly identify minor version bumps with 90% accuracy', async () => {
            const minorBumpTestCases = [
                AccuracyTestCases_1.AccuracyTestCases.getStructuredFeatureTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getVersionBumpMinorTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getHighConfidenceTestCase()
            ];
        ...
        it('should correctly identify patch version bumps with 90% accuracy', async () => {
            const patchBumpTestCases = [
                AccuracyTestCases_1.AccuracyTestCases.getStructuredBugFixTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getVersionBumpPatchTestCase()
            ];
        ...
        it('should correctly identify no version bump scenarios with 85% accuracy', async () => {
            const noBumpTestCases = [
                AccuracyTestCases_1.AccuracyTestCases.getEdgeCaseEmptyTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getEdgeCaseDocumentationOnlyTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getVersionBumpNoneTestCase()
            ];
    ...
    describe('Extraction Precision and Recall Standards', () => {
        it('should maintain precision above 80% for breaking changes', async () => {
            const breakingChangeTestCases = [
                ...
                AccuracyTestCases_1.AccuracyTestCases.getVersionBumpMajorTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getUnstructuredMixedTestCase(),
                AccuracyTestCases_1.AccuracyTestCases.getComplexStructuredTestCase()
            ];
    ...
    describe('Performance Regression Standards', () => {
        it('should complete validation within performance thresholds', async () => {
            const allTestCases = AccuracyTestCases_1.AccuracyTestCases.getAllTestCases();
...
//# sourceMappingURL=AccuracyRegressionTests.test.js.map