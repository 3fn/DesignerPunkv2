...
exports.AccuracyTestRunner = void 0;
...
class AccuracyTestRunner {
    constructor(config) {
        this.framework = new AccuracyValidationFramework_1.AccuracyValidationFramework(config);
    }
    /**
     ...
     */
    async runRegressionValidation(baselineResults) {
        return this.runTests({
            runRegression: true,
            baselineResults,
            outputFormat: 'detailed'
     ...
     */
    formatReport(report, format = 'detailed') {
        switch (format) {
            case 'json':
     ...
     */
    selectTestCases(options) {
        let testCases = AccuracyTestCases_1.AccuracyTestCases.getAllTestCases();
    ...
    generateSummary(results) {
        ...
        results.forEach(result => {
            const testCase = AccuracyTestCases_1.AccuracyTestCases.getAllTestCases().find(tc => tc.id === result.testCaseId);
            if (testCase) {
     ...
     */
    calculateSystemAccuracyMetrics(results) {
        const extraction = {
     ...
     */
    calculateSystemPerformanceMetrics(results) {
...
exports.AccuracyTestRunner = AccuracyTestRunner;
//# sourceMappingURL=AccuracyTestRunner.js.map