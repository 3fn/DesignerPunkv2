...
describe('ReleaseAnalysisErrorHandler', () => {
    ...
    let mockContext;
    beforeEach(() => {
        errorHandler = new ErrorHandler_1.ReleaseAnalysisErrorHandler();
        mockContext = {
...
describe('withErrorHandling utility', () => {
    ...
    it('should handle successful operations', async () => {
        ...
        const result = await (0, ErrorHandler_1.withErrorHandling)(successfulOperation, mockContext);
        expect(result.success).toBe(true);
    ...
    it('should handle Git errors', async () => {
        ...
        const result = await (0, ErrorHandler_1.withErrorHandling)(gitOperation, mockContext);
        expect(result.success).toBe(false);
    ...
    it('should handle parsing errors', async () => {
        ...
        const result = await (0, ErrorHandler_1.withErrorHandling)(parseOperation, mockContext);
    ...
    it('should handle unknown errors', async () => {
        ...
        const result = await (0, ErrorHandler_1.withErrorHandling)(unknownOperation, mockContext);
        expect(result.success).toBe(false);
...
describe('Error Recovery Integration', () => {
    describe('GitErrorRecovery', () => {
        let gitRecovery;
        beforeEach(() => {
            gitRecovery = new ErrorRecovery_1.GitErrorRecovery('/test/directory');
        });
    ...
    describe('DocumentErrorRecovery', () => {
        let docRecovery;
        beforeEach(() => {
            docRecovery = new ErrorRecovery_1.DocumentErrorRecovery();
        });
    ...
    describe('ConfigurationErrorRecovery', () => {
        let configRecovery;
        beforeEach(() => {
            configRecovery = new ErrorRecovery_1.ConfigurationErrorRecovery();
        });
