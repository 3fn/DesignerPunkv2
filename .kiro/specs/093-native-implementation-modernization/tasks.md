...
- [ ] 2. iOS Easing Modernization
  ...
  **Post-Completion:**
  ...
  - [ ] 2.1 Update FormInput family iOS easing (Checkbox-Base, Radio-Base)
    **Type**: Implementation
  ...
  - [ ] 2.2 Update Chip family iOS easing (Chip-Base, Chip-Filter, Chip-Input)
    **Type**: Implementation
    **Validation**: Tier 2 - Standard
    **Agent**: Lina (Kenya reviews)
  ...
  - [ ] 2.3 Update Button-VerticalList-Item iOS easing
    **Type**: Implementation
    **Validation**: Tier 2 - Standard
    **Agent**: Lina (Kenya reviews)
  ...
  - [ ] 2.4 Update Progress-Pagination-Base iOS easing
    **Type**: Implementation
    **Validation**: Tier 2 - Standard
    **Agent**: Lina (Kenya reviews)
    - `.easeInOut` → `MotionSelectionTransition`
  ...
  - [ ] 2.5 Update Nav-TabBar-Base iOS easing
    **Type**: Implementation
    **Validation**: Tier 2 - Standard
    **Agent**: Lina (Kenya reviews)
...
- [ ] 3. Android Modernization
  ...
  **Post-Completion:**
  ...
  - [ ] 3.1 Modernize Button-CTA Android config
    **Type**: Implementation
    **Validation**: Tier 2 - Standard
  ...
  - [ ] 3.2 Modernize Button-VerticalList-Item Android
    **Type**: Implementation
    **Validation**: Tier 2 - Standard
    **Agent**: Lina (Data reviews)
  ...
  - [ ] 3.3 Add easing + reduced motion to Checkbox/Radio Android
    **Type**: Implementation
    **Validation**: Tier 2 - Standard
    **Agent**: Lina (Data reviews)
  ...
  - [ ] 3.4 Replace Material checkmark in Progress-Node Android
    **Type**: Implementation
    **Validation**: Tier 2 - Standard
    **Agent**: Lina (Data reviews)
...
- [ ] 4. Documentation and Verification
  ...
  **Post-Completion:**
  ...
  - [ ] 4.1 Document ripple vs blend design decision
    **Type**: Implementation
    **Validation**: Tier 1 - Minimal
    **Agent**: Lina
