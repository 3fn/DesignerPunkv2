...
**For component development**: Consider creating a design outline before requirements to explore variants, token usage, and platform considerations. See Component Development and Practices Guide for component-specific spec methodology.
