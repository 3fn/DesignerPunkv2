...
import { MethodSignature, ParameterDefinition } from '../types/InterfaceDefinition';

describe('MethodSignatureValidator', () => {
  let validator: MethodSignatureValidator;

  beforeEach(() => {
    validator = new MethodSignatureValidator();
  });
  ...
  describe('validateMethodSignatures', () => {
    it('should validate matching method signatures', () => {
      ...
      const result = validator.validateMethodSignatures(
        iosMethods,
        androidMethods,
        'ios',
        'android'
