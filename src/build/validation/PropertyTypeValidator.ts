...
export class PropertyTypeValidator {
   ...
   */
  private compareProperties(comparison: PropertyComparison): ValidationError[] {
    const errors: ValidationError[] = [];
   ...
   */
  private comparePropertyTypes(comparison: PropertyComparison): ValidationError[] {
    const { property, platform, otherProperty, otherPlatform } = comparison;
    const errors: ValidationError[] = [];
   ...
   */
  private compareRequiredFlag(comparison: PropertyComparison): ValidationError[] {
    const { property, platform, otherProperty, otherPlatform } = comparison;
    const errors: ValidationError[] = [];
   ...
   */
  private compareDefaultValues(comparison: PropertyComparison): ValidationError[] {
    const { property, platform, otherProperty, otherPlatform } = comparison;
    const errors: ValidationError[] = [];
