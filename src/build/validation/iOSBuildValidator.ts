 ...
 */
export class iOSBuildValidator {
  /**
   * Validate iOS build output
   */
  async validate(buildResult: BuildResult): Promise<iOSValidationResult> {
   ...
   */
  private async validatePackageManifestFile(
    packagePath: string,
    errors: BuildError[],
    warnings: string[]
  ): Promise<boolean> {
   ...
   */
  private async validateSwiftConstants(
    packagePath: string,
    errors: BuildError[],
    warnings: string[]
  ): Promise<boolean> {
   ...
   */
  private async validateSwiftFile(
    filePath: string,
    errors: BuildError[],
    warnings: string[]
  ): Promise<boolean> {
   ...
   */
  private async validatePackageStructureFiles(
    packagePath: string,
    errors: BuildError[],
    warnings: string[]
  ): Promise<boolean> {
   ...
   */
  private async findSwiftFiles(dir: string): Promise<string[]> {
    const files: string[] = [];
   ...
   */
  private async listSwiftFiles(packagePath: string): Promise<string[]> {
    const sourcesPath = path.join(packagePath, 'Sources');
