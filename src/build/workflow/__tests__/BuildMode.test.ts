...
import { BuildModeManager } from '../BuildMode';
...
describe('BuildModeManager', () => {
  ...
  describe('getBuildModeDescription', () => {
    it('should return description for development mode', () => {
      ...
      expect(description).toBe(
        'Development mode: Fast builds, debugging enabled, no optimizations'
      );
    });
    ...
    it('should return description for production mode', () => {
      ...
      expect(description).toBe(
        'Production mode: Optimized builds, minification, performance focused'
      );
    });
  });
  ...
  describe('Integration scenarios', () => {
    ...
    it('should provide platform-specific optimizations for all platforms', () => {
      const platforms: Array<'ios' | 'android' | 'web'> = [
        'ios',
        'android',
        'web',
      ];
    ...
    it('should validate mode-specific configurations correctly', () => {
      ...
      expect(devResult.warnings.length).toBeLessThanOrEqual(
        prodResult.warnings.length
      );
    });
  });
});
