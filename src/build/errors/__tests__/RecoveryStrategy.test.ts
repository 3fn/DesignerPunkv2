...
describe('AbortStrategy', () => {
  let abortStrategy: AbortStrategy;

  beforeEach(() => {
    abortStrategy = new AbortStrategy();
  });
...
describe('RecoveryStrategyCoordinator', () => {
  let coordinator: RecoveryStrategyCoordinator;

  beforeEach(() => {
    coordinator = new RecoveryStrategyCoordinator();
  });
  ...
  describe('executeRecovery', () => {
    ...
    it('should handle unknown strategy', async () => {
      ...
      const result = await coordinator.executeRecovery('unknown' as any, context);
