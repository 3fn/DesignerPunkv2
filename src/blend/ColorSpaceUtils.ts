...
export interface HSL {
  ...
  s: number; // 0-1 (percentage as decimal)
  l: number; // 0-1 (percentage as decimal)
}
 ...
 */
export function calculateLighterBlend(baseColor: RGB, blendValue: number): RGB {
 ...
 */
export function calculateSaturateBlend(baseColor: RGB, blendValue: number): RGB {
  // Convert RGB to HSL
 ...
 */
export function calculateDesaturateBlend(baseColor: RGB, blendValue: number): RGB {
  // Convert RGB to HSL
  const hsl = rgbToHsl(baseColor);
