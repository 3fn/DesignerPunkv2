...
describe('ColorSpaceUtils', () => {
  ...
  describe('rgbToHex', () => {
    test('converts RGB to 6-digit hex with # prefix', () => {
      const result = rgbToHex({ r: 168, g: 85, b: 247 });
    ...
    test('clamps values below 0 to 0', () => {
      const result = rgbToHex({ r: -10, g: 100, b: 200 });
      expect(result).toBe('#0064C8');
    });

    test('clamps values above 255 to 255', () => {
      const result = rgbToHex({ r: 300, g: 100, b: 200 });
  ...
  describe('rgbToHsl', () => {
    test('converts purple RGB to HSL', () => {
      const result = rgbToHsl({ r: 168, g: 85, b: 247 });
  ...
  describe('hslToRgb', () => {
    test('converts purple HSL to RGB', () => {
      const result = hslToRgb({ h: 271, s: 0.91, l: 0.65 });
  ...
  describe('round-trip conversions', () => {
    test('RGB → HSL → RGB preserves color', () => {
      const original: RGB = { r: 168, g: 85, b: 247 };
    ...
    test('HSL → RGB → HSL preserves color', () => {
      const original: HSL = { h: 271, s: 0.91, l: 0.65 };
  ...
  describe('edge cases', () => {
    test('handles maximum saturation', () => {
      const hsl: HSL = { h: 180, s: 1.0, l: 0.5 };
    ...
    test('handles minimum saturation', () => {
      const hsl: HSL = { h: 180, s: 0.0, l: 0.5 };
      const rgb = hslToRgb(hsl);
      const result = rgbToHsl(rgb);
    ...
    test('handles hue wraparound at 360 degrees', () => {
      const hsl1 = hslToRgb({ h: 0, s: 1, l: 0.5 });
      const hsl2 = hslToRgb({ h: 360, s: 1, l: 0.5 });
  ...
  describe('calculateDarkerBlend', () => {
    test('darkens purple500 by 8% (blend200)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateDarkerBlend(baseColor, 0.08);
    ...
    test('darkens blue500 by 12% (blend300)', () => {
      const baseColor: RGB = { r: 59, g: 130, b: 246 };
      const result = calculateDarkerBlend(baseColor, 0.12);
    ...
    test('darkens red by 4% (blend100)', () => {
      const baseColor: RGB = { r: 255, g: 0, b: 0 };
      const result = calculateDarkerBlend(baseColor, 0.04);
    ...
    test('darkens white by 20% (blend500)', () => {
      const baseColor: RGB = { r: 255, g: 255, b: 255 };
      const result = calculateDarkerBlend(baseColor, 0.20);
    ...
    test('handles black color (no change possible)', () => {
      const baseColor: RGB = { r: 0, g: 0, b: 0 };
      const result = calculateDarkerBlend(baseColor, 0.08);
    ...
    test('clamps RGB values to 0-255 range', () => {
      const baseColor: RGB = { r: 10, g: 5, b: 3 };
      const result = calculateDarkerBlend(baseColor, 0.50);
    ...
    test('handles zero blend value (no change)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateDarkerBlend(baseColor, 0.0);
    ...
    test('handles maximum blend value (complete darkening)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateDarkerBlend(baseColor, 1.0);
    ...
    test('produces darker colors for all RGB components', () => {
      const baseColor: RGB = { r: 100, g: 150, b: 200 };
      const result = calculateDarkerBlend(baseColor, 0.10);
  ...
  describe('calculateLighterBlend', () => {
    test('lightens purple500 by 8% (blend200)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateLighterBlend(baseColor, 0.08);
    ...
    test('lightens blue500 by 12% (blend300)', () => {
      const baseColor: RGB = { r: 59, g: 130, b: 246 };
      const result = calculateLighterBlend(baseColor, 0.12);
    ...
    test('lightens red by 4% (blend100)', () => {
      const baseColor: RGB = { r: 255, g: 0, b: 0 };
      const result = calculateLighterBlend(baseColor, 0.04);
    ...
    test('lightens black by 20% (blend500)', () => {
      const baseColor: RGB = { r: 0, g: 0, b: 0 };
      const result = calculateLighterBlend(baseColor, 0.20);
    ...
    test('clamps RGB values to 0-255 range', () => {
      const baseColor: RGB = { r: 250, g: 245, b: 240 };
      const result = calculateLighterBlend(baseColor, 0.50);
    ...
    test('handles zero blend value (no change)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateLighterBlend(baseColor, 0.0);
    ...
    test('handles maximum blend value (complete lightening)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateLighterBlend(baseColor, 1.0);
    ...
    test('produces lighter colors for all RGB components', () => {
      const baseColor: RGB = { r: 100, g: 150, b: 200 };
      const result = calculateLighterBlend(baseColor, 0.10);
    ...
    test('lightens dark purple on dark background', () => {
      const baseColor: RGB = { r: 80, g: 40, b: 120 };
      const result = calculateLighterBlend(baseColor, 0.08);
  ...
  describe('calculateSaturateBlend', () => {
    test('saturates purple500 by 8% (blend200)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateSaturateBlend(baseColor, 0.08);
      
      // Convert to HSL to verify saturation increased
      const originalHsl = rgbToHsl(baseColor);
    ...
    test('saturates blue500 by 12% (blend300)', () => {
      const baseColor: RGB = { r: 59, g: 130, b: 246 };
      const result = calculateSaturateBlend(baseColor, 0.12);
    ...
    test('saturates desaturated color by 20% (blend500)', () => {
      const baseColor: RGB = { r: 150, g: 120, b: 180 };
      const result = calculateSaturateBlend(baseColor, 0.20);
    ...
    test('clamps saturation to maximum 1.0', () => {
      const baseColor: RGB = { r: 255, g: 0, b: 0 }; // Pure red, saturation = 1.0
      const result = calculateSaturateBlend(baseColor, 0.20);
    ...
    test('clamps saturation to minimum 0.0', () => {
      const baseColor: RGB = { r: 128, g: 128, b: 128 }; // Gray, saturation = 0.0
      const result = calculateSaturateBlend(baseColor, -0.20);
    ...
    test('handles zero blend value (no change)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateSaturateBlend(baseColor, 0.0);
    ...
    test('handles grayscale color (saturation = 0)', () => {
      const baseColor: RGB = { r: 128, g: 128, b: 128 };
      const result = calculateSaturateBlend(baseColor, 0.08);
    ...
    test('produces more vibrant colors', () => {
      const baseColor: RGB = { r: 100, g: 150, b: 200 };
      const result = calculateSaturateBlend(baseColor, 0.15);
    ...
    test('saturates already saturated color', () => {
      const baseColor: RGB = { r: 200, g: 50, b: 50 }; // Already fairly saturated red
      const result = calculateSaturateBlend(baseColor, 0.10);
  ...
  describe('calculateDesaturateBlend', () => {
    test('desaturates purple500 by 8% (blend200)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateDesaturateBlend(baseColor, 0.08);
    ...
    test('desaturates blue500 by 12% (blend300) for disabled state', () => {
      const baseColor: RGB = { r: 59, g: 130, b: 246 };
      const result = calculateDesaturateBlend(baseColor, 0.12);
    ...
    test('desaturates vibrant color by 20% (blend500)', () => {
      const baseColor: RGB = { r: 255, g: 50, b: 50 };
      const result = calculateDesaturateBlend(baseColor, 0.20);
    ...
    test('clamps saturation to minimum 0.0', () => {
      const baseColor: RGB = { r: 200, g: 180, b: 190 }; // Low saturation color
      const result = calculateDesaturateBlend(baseColor, 0.50);
    ...
    test('handles zero blend value (no change)', () => {
      const baseColor: RGB = { r: 168, g: 85, b: 247 };
      const result = calculateDesaturateBlend(baseColor, 0.0);
    ...
    test('produces more muted colors', () => {
      const baseColor: RGB = { r: 100, g: 150, b: 200 };
      const result = calculateDesaturateBlend(baseColor, 0.15);
    ...
    test('desaturates already desaturated color', () => {
      const baseColor: RGB = { r: 150, g: 140, b: 145 }; // Already fairly desaturated
      const result = calculateDesaturateBlend(baseColor, 0.10);
    ...
    test('creates disabled state appearance', () => {
      const baseColor: RGB = { r: 59, g: 130, b: 246 }; // Blue500
      const result = calculateDesaturateBlend(baseColor, 0.12);
    ...
    test('desaturate and saturate are inverse operations', () => {
      ...
      const desaturated = calculateDesaturateBlend(baseColor, blendValue);
      const resaturated = calculateSaturateBlend(desaturated, blendValue);
    ...
    test('handles maximum desaturation (approaching grayscale)', () => {
      const baseColor: RGB = { r: 200, g: 50, b: 50 }; // Saturated red
      const result = calculateDesaturateBlend(baseColor, 1.0);
