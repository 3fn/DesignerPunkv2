...
import { MathematicalRelationshipParser } from '../MathematicalRelationshipParser';

describe('MathematicalRelationshipParser', () => {
  let parser: MathematicalRelationshipParser;

  beforeEach(() => {
    parser = new MathematicalRelationshipParser();
  });
