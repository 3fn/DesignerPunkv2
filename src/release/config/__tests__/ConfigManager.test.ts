...
import { ConfigManager, DEFAULT_RELEASE_CONFIG, validateConfig } from '../index';
...
describe('ConfigManager', () => {
  ...
  describe('Default Configuration', () => {
    it('should have valid default configuration', () => {
      const validation = validateConfig(DEFAULT_RELEASE_CONFIG);
      expect(validation.valid).toBe(true);
      expect(validation.errors).toHaveLength(0);
    });

    it('should include all required configuration sections', () => {
      expect(DEFAULT_RELEASE_CONFIG.detection).toBeDefined();
      expect(DEFAULT_RELEASE_CONFIG.versioning).toBeDefined();
      expect(DEFAULT_RELEASE_CONFIG.publishing).toBeDefined();
      expect(DEFAULT_RELEASE_CONFIG.validation).toBeDefined();
    });

    it('should have reasonable default values', () => {
      const config = DEFAULT_RELEASE_CONFIG;
  ...
  describe('Configuration Summary', () => {
    it('should generate configuration summary', () => {
      const summary = configManager.getConfigSummary(DEFAULT_RELEASE_CONFIG);
  ...
  describe('Configuration Validation Report', () => {
    it('should generate detailed validation report', () => {
      const report = configManager.validateConfiguration(DEFAULT_RELEASE_CONFIG);
