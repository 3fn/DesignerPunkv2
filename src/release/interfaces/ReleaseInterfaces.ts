...
// CoordinationStrategy, CoordinationPlan, CompatibilityReport, CompatibilityIssue, 
// CompatibilityWarning, and VersionConflict are imported from ReleaseTypes.ts
