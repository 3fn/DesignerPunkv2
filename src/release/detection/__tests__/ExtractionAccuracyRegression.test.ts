...
`,
      ...
      const validateOldChange = analysis.breakingChanges.find(bc => 
        bc.title.includes('validateOld')
      );
      ...
      const validationOptionsChange = analysis.breakingChanges.find(bc => 
        bc.title.includes('ValidationOptions')
      );
