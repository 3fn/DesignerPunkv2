...
/**
 * Keyboard Navigation Tests for Input-Text-Base
 * 
 ...
 * 
 * Requirements: 6.1, 6.2, 6.3, R3
 * Ported from: TextInputField/__tests__/keyboardNavigation.test.ts
 */

import { setupBlendColorProperties, cleanupBlendColorProperties } from './test-utils';

describe('Input-Text-Base - Keyboard Navigation', () => {
  ...
  describe('Enter Key Form Submission (Requirement 6.2)', () => {
    it('should submit form when Enter key is pressed in input', () => {
      ...
      const component = form.querySelector('input-text-base') as any;
      const input = component.shadowRoot.querySelector('.input-element') as HTMLInputElement;
  ...
  describe('Keyboard Navigation Flow (Requirement 6.3)', () => {
    it('should maintain proper tab order with multiple inputs', () => {
      ...
      const components = container.querySelectorAll('input-text-base');
    ...
    it('should handle rapid focus changes correctly', () => {
      ...
      const component1 = container.querySelectorAll('input-text-base')[0] as any;
      const component2 = container.querySelectorAll('input-text-base')[1] as any;
