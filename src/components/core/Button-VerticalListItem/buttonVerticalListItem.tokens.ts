/**
 * Button-VerticalListItem Component Token Definitions
 * 
 * Stemma System naming: [Family]-[Type] = Button-VerticalListItem
 * Type: Primitive (foundational component)
 * 
 * Platform-agnostic token definitions for the Button-VerticalListItem component.
...
/**
 * Button-VerticalListItem component tokens defined using the hybrid authoring API.
 * 
...
/**
 * Type for Button-VerticalListItem padding block variants
 */
export type VerticalListItemPaddingBlockVariant = 'rest' | 'selected';

/**
 * Get Button-VerticalListItem padding block value for a given state variant
 * 
...
/**
 * Semantic token references for Button-VerticalListItem padding block values
 * 
...
/**
 * Get the primitive token reference or derivation for a Button-VerticalListItem padding block variant
 * 
 * @param variant - State variant ('rest' | 'selected')
