/**
 * Test utilities for Button-VerticalListItem component testing
 * 
...
/**
 * Set up required CSS custom properties for Button-VerticalListItem.
 * 
 * Button-VerticalListItem requires these tokens to be present for fail-loudly validation.
...
/**
 * Register the Button-VerticalListItem custom element if not already registered.
...
/**
 * Props interface for creating Button-VerticalListItem elements
 */
...
/**
 * Create a Button-VerticalListItem element with shadow DOM ready
 * 
...
/**
 * Clean up a Button-VerticalListItem element from the DOM
 * 
...
/**
 * Get the shadow button element from a Button-VerticalListItem
 * 
 * @param button - The Button-VerticalListItem custom element
...
/**
 * Get the label element from a Button-VerticalListItem
 * 
 * @param button - The Button-VerticalListItem custom element
...
/**
 * Get the description element from a Button-VerticalListItem
 * 
 * @param button - The Button-VerticalListItem custom element
...
/**
 * Get the leading icon container from a Button-VerticalListItem
 * 
 * @param button - The Button-VerticalListItem custom element
...
/**
 * Get the checkmark container from a Button-VerticalListItem
 * 
 * @param button - The Button-VerticalListItem custom element
