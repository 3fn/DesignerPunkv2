/**
 * @category evergreen
 * @purpose Integration tests for Button-VerticalList-Item component
...
describe('Button-VerticalList-Item Integration Tests', () => {
  // ─────────────────────────────────────────────────────────────────
  ...
  describe('Icon-Base Integration', () => {
     ...
     * Button-VerticalList-Item → icon-base → SVG
     */
