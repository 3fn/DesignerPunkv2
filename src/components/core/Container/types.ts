 ...
 * 
 * Platform-agnostic TypeScript interfaces for the Container component.
...
/**
 * Padding values for Container component
 * 
...
/**
 * Border width values for Container component
 * 
...
/**
 * Border radius values for Container component
 * 
...
/**
 * Layering values for Container component
 * 
 ...
 * 
 * Web-specific prop that allows Container to render as semantic HTML elements
...
export interface ContainerProps {
   ...
   * 
   * Allows Container to render as semantic HTML elements for improved
   ...
   * 
   * When true, Container extends into safe area regions (notch, home indicator).
