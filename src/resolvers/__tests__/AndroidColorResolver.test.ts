...
import { AndroidColorResolver, AndroidOutputOptions } from '../AndroidColorResolver';
...
describe('AndroidColorResolver', () => {
  let resolver: AndroidColorResolver;

  beforeEach(() => {
    resolver = new AndroidColorResolver();
  });
  ...
  describe('Custom Configuration', () => {
    test('should support all configuration options together', () => {
      const tokens = createMultipleColorTokens();
      const options: AndroidOutputOptions = {
