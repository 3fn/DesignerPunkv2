/**
 * @category evergreen
 * @purpose Verify iOSColorResolver functionality works correctly
 */
/**
...
import { iOSColorResolver, SwiftOutputOptions } from '../iOSColorResolver';
...
describe('iOSColorResolver', () => {
  let resolver: iOSColorResolver;

  beforeEach(() => {
    resolver = new iOSColorResolver();
  });
  ...
  describe('Custom Configuration', () => {
    test('should support all configuration options together', () => {
      const colorToken = createMockColorToken();
      const options: SwiftOutputOptions = {
