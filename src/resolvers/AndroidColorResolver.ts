 ...
 */
export class AndroidColorResolver {
   ...
   */
  private hexToAndroidColor(hex: string): string {
   ...
   */
  private generateColorResource(tokenName: string, colorValue: string): string {
