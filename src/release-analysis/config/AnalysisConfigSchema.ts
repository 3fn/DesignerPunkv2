 ...
 */
export function validateAnalysisConfig(config: any): AnalysisConfigValidationResult {
...
function validateExtractionConfig(
  config: any,
  path: string,
  errors: ConfigValidationError[],
  warnings: ConfigValidationWarning[]
...
function validateVersioningConfig(
  config: any,
  path: string,
  errors: ConfigValidationError[],
  warnings: ConfigValidationWarning[]
...
function validateReportingConfig(
  config: any,
  path: string,
  errors: ConfigValidationError[],
  warnings: ConfigValidationWarning[]
 ...
 */
export function validateConfigurationPaths(config: any): AnalysisConfigValidationResult {
  const errors: ConfigValidationError[] = [];
  const warnings: ConfigValidationWarning[] = [];
