...
const exampleChanges: ExtractedChanges = {
  breakingChanges: [
    {
      id: 'break-1',
...
async function demonstrateMinimalTemplate() {
  ...
  const minimalTemplate: ReleaseTemplate = {
    format: 'markdown',
    sections: [
...
export {
  ...
  demonstrateCustomTemplate,
  demonstrateIndividualFormatting,
  demonstrateMinimalTemplate,
  demonstrateEmptyChanges,
  runExamples
};
