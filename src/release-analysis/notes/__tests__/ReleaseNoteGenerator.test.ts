...
import { ReleaseNoteGenerator, ReleaseTemplate } from '../ReleaseNoteGenerator';
import { 
  ExtractedChanges, 
  BreakingChange, 
  Feature, 
...
describe('ReleaseNoteGenerator', () => {
  ...
  describe('generateReleaseNotes', () => {
    ...
    it('should apply custom template correctly', async () => {
      const customTemplate: ReleaseTemplate = {
        format: 'markdown',
        sections: [
  ...
  describe('formatBreakingChanges', () => {
    ...
    it('should handle breaking changes without optional fields', () => {
      const minimalBreakingChange: BreakingChange = {
        id: 'break-minimal',
  ...
  describe('formatImprovements', () => {
    ...
    it('should handle improvements without optional fields', () => {
      const minimalImprovement: Improvement = {
        id: 'imp-minimal',
  ...
  describe('summary generation', () => {
    ...
    it('should handle singular vs plural correctly', async () => {
      const singleChanges: ExtractedChanges = {
        ...mockChanges,
