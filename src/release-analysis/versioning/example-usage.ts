...
export function demonstrateVersionCalculation() {
  ...
  const newFeatures: ExtractedChanges = {
    breakingChanges: [],
    newFeatures: [{
      id: '2',
  ...
  const bugFixes: ExtractedChanges = {
    breakingChanges: [],
    newFeatures: [],
    bugFixes: [{
      id: '3',
...
export function exampleCLIIntegration(changes: ExtractedChanges, currentVersion: string) {
  const calculator = new VersionCalculator();
