...
export interface BugFix {
  ...
  description: string;
  issueNumber?: string;
  issueReference?: string; // Added from ReleaseTypes for compatibility
...
export interface EnhancedExtractionValidation extends ExtractionValidation {
  confidenceScore: any; // Will be imported from ConfidenceMetrics when needed
...
// Enhanced types adapted from ReleaseTypes.ts for CLI workflow
...
// Release Notes types adapted from ReleaseTypes.ts
...
// Quick Analysis types for hook integration
