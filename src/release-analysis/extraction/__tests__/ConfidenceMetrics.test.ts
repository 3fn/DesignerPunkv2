...
describe('ConfidenceMetrics', () => {
  ...
  let mockThresholds: ConfidenceThresholds;
  ...
  beforeEach(() => {
    ...
    confidenceMetrics = new ConfidenceMetrics(mockThresholds);
  });
  ...
  describe('calculateConfidenceScore', () => {
    it('should calculate overall confidence score from components', () => {
      ...
      const mockDocuments: CompletionDocument[] = [
  ...
  describe('calculateItemConfidence', () => {
    it('should calculate confidence for individual items', () => {
      ...
      const context = {
        documentStructure: 'structured' as const,
        extractionMethod: 'section' as const,
        sectionMatch: {
          header: 'New Features',
    ...
    it('should identify uncertainties for low-quality items', () => {
      ...
      const context = {
        documentStructure: 'unstructured' as const,
  ...
  function createMockBreakingChange(): BreakingChange {
    return {
      id: 'breaking-1',
  ...
  function createMockBugFix(): BugFix {
    return {
      id: 'bugfix-1',
  ...
  function createMockImprovement(): Improvement {
    return {
      id: 'improvement-1',
  ...
  function createMockDocument(path: string, content: string): CompletionDocument {
    return {
      path,
      content,
