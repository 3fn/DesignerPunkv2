...
async function basicValidationExample() {
  ...
  const versionRecommendation: VersionRecommendation = {
...
async function customConfigurationExample() {
  ...
  const strictValidator = new AnalysisValidator(customConfig);
...
async function componentValidationExample() {
  ...
  const invalidVersionRecommendation: VersionRecommendation = {
  ...
  const mockChanges: ExtractedChanges = {
    breakingChanges: [
      {
        id: '1',
...
- Various improvements`;  // Poor quality notes
  ...
  const lowConfidenceChanges: ExtractedChanges = {
    ...mockChanges,
    metadata: {
  ...
  const lowConfidenceVersion: VersionRecommendation = {
...
async function cliIntegrationExample() {
  ...
  function simulateCliValidation(changes: ExtractedChanges, version: VersionRecommendation, notes: string) {
  ...
  const goodChanges: ExtractedChanges = {
    breakingChanges: [],
    newFeatures: [
      {
        id: '1',
  ...
  const goodVersion: VersionRecommendation = {
