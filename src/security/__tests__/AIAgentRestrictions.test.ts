...
describe('AIAgentRestrictions', () => {
  let restrictions: AIAgentRestrictions;
  let humanContext: RestrictionContext;
  let aiContext: RestrictionContext;

  beforeEach(() => {
    restrictions = new AIAgentRestrictions();
  ...
  describe('Statistics and Logging', () => {
    ...
    it('should track blocked actions', () => {
      const blockedToken: PrimitiveToken = {
        name: 'space085',
        category: TokenCategory.SPACING,
        baseValue: 7,
        familyBaseValue: 8,
    ...
    it('should calculate block rate', () => {
      const allowedToken: PrimitiveToken = {
        name: 'space100',
        category: TokenCategory.SPACING,
        baseValue: 8,
        familyBaseValue: 8,
