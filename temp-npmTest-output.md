 ...
 PASS  src/build/errors/__tests__/RecoveryStrategy.test.ts (6.745 s)
 PASS  src/release-analysis/cli/__tests__/ReleaseCLI.test.ts (13.834 s)
  ● Console
    ...
    console.log
      📄 Found 568 completion documents
...
Summary of all failing tests
 ...
 FAIL  src/__tests__/integration/PerformanceValidation.test.ts
  ● Performance Validation Integration › Statistics and Health Check Performance › should get statistics without regression

    expect(received).toBeLessThan(expected)

    Expected: < 2
    Received:   2.6567079999999805

      425 |
      426 |       const duration = endTime - startTime;
    > 427 |       expect(duration).toBeLessThan(REGRESSION_THRESHOLDS.statistics);
          |                        ^
      428 |     });
      429 |
      430 |     it('should get health status within normal threshold', () => {

      at Object.<anonymous> (src/__tests__/integration/PerformanceValidation.test.ts:427:24)
 ...
 FAIL  src/release/detection/__tests__/WorkflowMonitor.test.ts
  ...
  ● WorkflowMonitor › Event Queue Management › should queue events and process them in order
    ...
    Expected length: 3
    Received length: 2
    Received array:  [{"metadata": {}, "source": "test-source-1", "timestamp": 2025-11-24T19:12:47.367Z, "type": "task-completion"}, {"metadata": {}, "source": "test-source-2", "timestamp": 2025-11-24T19:12:47.367Z, "type": "spec-completion"}]
...
Tests:       19 failed, 13 skipped, 3947 passed, 3979 total
Snapshots:   0 total
Time:        14.229 s, estimated 19 s
Ran all test suites.
